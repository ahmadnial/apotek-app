            ...
            <div class="card-body">
                ...
                <table class="table table-stripped table-bordered" id="example1">
                    ...
                    <tbody>
                        @foreach ($data as $x)
                        <tr>
                            <td>{{$x->Kode_Golongan}}</td>
                            <td>{{$x->Golongan_Produk}}</td>
                        </tr>
                        @endforeach
                    </tbody>
                </table>
